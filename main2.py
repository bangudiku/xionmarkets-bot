...
async def main():
    ...
    async with async_playwright() as p:
        browser = await p.chromium.launch(headless=True)  # Headless mode aktif
        ...
        while True:
            try:
                ...
                print(Fore.GREEN + f"✅ {transaction_type.capitalize()} berhasil di '{selected_market_name}'! Tunggu {DELAY_AFTER_SUCCESS} detik...")
